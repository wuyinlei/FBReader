...
public final class ProgressItemView_
    extends ProgressItemView
    implements HasViews, OnViewChangedListener
{
    ...
    public ProgressItemView_(Context context) {
        super(context);
        init_();
    }

    public static ProgressItemView build(Context context) {
        ProgressItemView_ instance = new ProgressItemView_(context);
    ...
    public void onFinishInflate() {
        if (!alreadyInflated_) {
            ...
            inflate(getContext(), layout.pop_progress, this);
