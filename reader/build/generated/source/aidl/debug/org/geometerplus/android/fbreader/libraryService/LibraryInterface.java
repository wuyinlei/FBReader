 ...
 * Original file: E:\\MyApplication\\reader\\src\\main\\aidl\\org\\geometerplus\\android\\fbreader\\libraryService\\LibraryInterface.aidl
 */
...
java.lang.String _arg1;
_arg1 = data.readString();
boolean _result = this.saveCover(_arg0, _arg1);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
@Override public boolean saveCover(java.lang.String book, java.lang.String url) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
mRemote.transact(Stub.TRANSACTION_saveCover, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
static final int TRANSACTION_saveCover = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_bookmarks = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_saveBookmark = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_deleteBookmark = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getHighlightingStyle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_highlightingStyles = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_saveHighlightingStyle = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_rescan = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
}
...
public boolean saveCover(java.lang.String book, java.lang.String url) throws android.os.RemoteException;
